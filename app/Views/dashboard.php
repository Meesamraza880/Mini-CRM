...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-primary border border-0" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-add-company" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                            <i class="fas fa-fw fa-table"></i>
                            <span>Add company</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn-primary border border-0" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-employee" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                            <i class="fas fa-fw fa-table"></i>
                            <span>Employee table</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn-primary border border-0" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-company" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                            <i class="fas fa-fw fa-table"></i>
                            <span>Company table</span></a>
                    </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-add-company" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                        <?php require_once('company.php') ?>
                    </div>
                    <div class="tab-pane fade" id="nav-employee" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                        <?php require_once('employee_table.php') ?>
                    </div>
                    <div class="tab-pane fade" id="nav-company" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                        <?php require_once('company_table.php') ?>
                    </div>
    ...
    <div class="modal fade" id="edit_company" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <form id="update_company">
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control" id="modal_name" name="name" value="" placeholder="Name">
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="modal_email" name="email" placeholder="Email">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="modal_website" name="website" placeholder="website">
                                <input type="hidden" id="modal_id" name="company_id">
                            </div>
                            <div class="col-sm-6">
                                <select class="form-select" name="status" id="modal_status" aria-label="Default select example">
    ...
    <div class="modal fade" id="edit_employee_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    ...
                    <form class="row g-3 d-flex justify-content-center needs-validation  p-3 mb-3 mt-3" id="update_employee">

                        <div class="col-sm-6">

                            <input type="text" class="form-control" id="em_fname" placeholder="First name" name="fname" required>

                        </div>
                        <div class="col-sm-6">

                            <input type="text" class="form-control" id="em_lname" placeholder="Last name" name="lname" required>
                        ...
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <div class="input-group has-validation">
                                <span class="input-group-text Cfont" id="inputGroupPrepend">@</span>
                                <input type="text" class="form-control" id="em_email" placeholder="Email" name="email" aria-describedby="inputGroupPrepend" required>
                        ...
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <select class="form-select" aria-label="Default select example" id="em_company" name="company">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="em_phone" placeholder="#phone" name="phone" required>
                        ...
                        <div class="col-sm-6 ">
                            ...
                            <select class="form-select" aria-label="Default select example" id="em_status" name="status">
