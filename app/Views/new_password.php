        ...
        <div class="card-body p-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="p-5">
                        <form class="row g-3 d-flex justify-content-center Cform needs-validation p-3 mt-5" method="POST" action="new_pass_process" novalidate>
                            ...
                            <div class="d-grid gap-2 col-10 mx-auto col-md-8 mb-4">
                                <input type="hidden" name="id" value="<?php echo session()->getFlashdata('user_id') ?>">
